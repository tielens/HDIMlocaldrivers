...
plot(diversity(hem.both)/log(specnumber(hem.both))~env.both$morphotype, ylab="Pielou's Evenness")
```
...
model4th<-traitglm(hem.sub, leaftraits[,c(1,2,3,4,6)], traits,  method="manyglm", family="negative.binomial")
