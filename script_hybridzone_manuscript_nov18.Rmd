...
points(mds.fig, "sites", pch = 17, col = "green", select = env[env$site=="KAIO",]$morphotype == "G")

Lab<-c( "Hybrid", "Pubescent", "Glabrous")
#color<-c("blue", "red", "green")
legend(  "topright", legend=Lab,pch=c(15,19, 17),col=c("blue", "red", "green"),pt.cex=1.1,cex=0.9,xpd=TRUE)
...
points(mds.fig, "sites", pch = 17, col = "green", select = env.kai.all$morphotype == "G")
Lab<-c( "Hybrid", "Pubescent", "Glabrous")
legend(  "topright", legend=Lab,pch=c(15,19, 17),col=c("blue", "red", "green"),pt.cex=1.1,cex=0.9,xpd=TRUE)
