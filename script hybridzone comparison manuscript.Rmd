...
ordiellipse(p,groups=env.both$morphotype,draw="polygon",col="grey90",label=T)
```
<br>
...
adonis(hem.2014~leaftraits$morphotype+leaftraits$percN+leaftraits$meanWatercontent+leaftraits$meanSLA+leaftraits$percP+env.2014$site+scale(xy.2014$lat,scale=T,center=T), by="margin")
